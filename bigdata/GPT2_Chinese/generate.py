...
from bigdata.GPT2_Chinese.tokenizations import tokenization_bert

device = "cuda" if torch.cuda.is_available() else "cpu"
tokenizer_path = "bigdata/GPT2_Chinese/model/vocab.txt"
model_path = 'bigdata/GPT2_Chinese/model/'
